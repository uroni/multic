...
set xlabel "decrease"
set ylabel "Received Bytes/s - mean"
set output "gnup.p.eps"
plot "gnup.p.dat" using 1:2 title "AimdCC-increase=0.5","gnup.p.dat" using 1:3 title "AimdCC-increase=0.75","gnup.p.dat" using 1:4 title "AimdCC-increase=1.0","gnup.p.dat" using 1:5 title "AimdCC-increase=1.5"
