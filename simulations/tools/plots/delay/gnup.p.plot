...
set xlabel "delay between peers in ms"
set ylabel "Received Bytes/s from Overlay - mean"
set output "gnup.p.eps"
plot "delay-qlearn.dat" using 1:2 title "QLearnCC", "delay-aimd.dat" using 1:2 title "AimdCC", "delay-basic.dat" using 1:2 title "BasicCC", "delay-perfect.dat" using 1:2 title "PerfectCC"
