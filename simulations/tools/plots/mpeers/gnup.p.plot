...
plot "gnup.aimdcc.dat" using 1:2 title "AimdCC", "gnup.perfectcc.dat" using 1:2 title "PerfectCC", "gnup.qlearncc.dat" using 1:2 title "QLearnCC", "gnup.basicc.dat" using 1:2 title "BasicCC"
