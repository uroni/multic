...
plot "nhops-perfect.dat" using 1:2 title "PerfectCC", "nhops-basic.dat" using 1:2 title "BasicCC", "nhops-aimd.dat" using 1:2 title "AimdCC", "nhops-qlearn.dat" using 1:2 title "QLearnCC"
