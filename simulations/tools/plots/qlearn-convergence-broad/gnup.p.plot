...
plot "gnup.p.dat" using 1:2 title "QLearnCC-lamda=0.4, epsilon=0.1","gnup.p.dat" using 1:3 title "QLearnCC-lamda=0.8, epsilon=0.1","gnup.p.dat" using 1:4 title "QLearnCC-lamda=1.0, epsilon=0.1"
