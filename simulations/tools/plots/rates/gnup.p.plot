...
set xlabel "Available rate per peer in byte/s"
set ylabel "Received Bytes/s from Overlay - mean"
set output "gnup.p.eps"
plot "rates-qlearn.dat" using 1:2 title "QLearnCC", "rates-aimd.dat" using 1:2 title "AimdCC", "rates-basic.dat" using 1:2 title "BasicCC", "rates-perfect.dat" using 1:2 title "PerfectCC"
