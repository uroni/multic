...
set xlabel "alpha"
set ylabel "Delayed acknowledgements per second - mean"
set output "gnup.p.eps"
plot "gnup.p.dat" using 1:2 title "Delayed acknowledgements", \
	"gnup.p.dat" using 1:2 smooth bezier title "Bezier smoothed curve through data" with lines
